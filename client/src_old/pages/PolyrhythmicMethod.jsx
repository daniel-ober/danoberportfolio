// client/src/pages/PolyrhythmicMethod.jsx
import React, { useMemo, useState } from "react";
import { DISCIPLINES, DISCIPLINE_ORDER as ORDER } from "../config/disciplines";
    ...
    <main className="pm-page">
          ...
          <div className="pm-hero__modes">
            <header className="pm-section__header pm-section__header--compact">
              ...
              <p className="pm-section__subtitle">
                How I decide whether a problem needs one discipline in tight
                focus, a multi-disciplined toolbox, or a fully poly-disciplined,
            ...
            <div className="pm-grid pm-grid--modes">
              ...
              <article className="pm-mode">
                ...
                <p className="pm-mode__body">
                  Used when clarity and speed matter most. I stay inside one
                  lane — engineering, product, or craft — and push that rhythm
                  as cleanly as possible. Examples: hardening an auth flow,
                  refactoring a component, debugging a production issue, or
              ...
              <article className="pm-mode">
                ...
                <p className="pm-mode__tag">
                  Several disciplines, used individually
                </p>
                <p className="pm-mode__body">
                  Here the value is range. I can move between engineering, UX,
                  systems, and story as separate modes — knowing when to switch
                  hats and which discipline should lead in a given moment.
                  Think: a week where I&apos;m deep in React early on, then
                  shifting into product strategy or copy later without losing
                  context.
                </p>
              </article>
              ...
              <article className="pm-mode pm-mode--highlight">
                ...
                <p className="pm-mode__body">
                  This is the polyrhythmic stack. It&apos;s not just having more
                  than one discipline — it&apos;s knowing{" "}
                  <em>how and when to blend them</em> so the work behaves like a
                  small, cross-functional team inside one brain. Examples:
                  designing and building the SoundLegend portal, where
                  engineering, product, systems, story, and physical craft all
                  show up in a single, coherent experience.
                </p>
              </article>
            </div>
          </div>
      ...
      <section className="pm-section">
        <header className="pm-section__header">
          <h2 className="pm-section__title">Core Disciplines</h2>
          <p className="pm-section__subtitle">
        ...
        <div className="pm-grid pm-grid--disciplines">
          {/* Web & Software */}
          <article className="pm-card pm-card--web">
            <div className="pm-card__icon">
              <Monitor className="pm-card__icon-img" aria-hidden="true" />
            </div>
          ...
          {/* Product & UX */}
          <article className="pm-card pm-card--product">
            <div className="pm-card__icon">
              <Boxes className="pm-card__icon-img" aria-hidden="true" />
            </div>
          ...
          <article className="pm-card pm-card--problem">
            <div className="pm-card__icon">
              <Puzzle className="pm-card__icon-img" aria-hidden="true" />
            </div>
          ...
          {/* Craft & Making */}
          <article className="pm-card pm-card--craft">
            <div className="pm-card__icon">
              <Hammer className="pm-card__icon-img" aria-hidden="true" />
            </div>
          ...
          <article className="pm-card pm-card--story">
            <div className="pm-card__icon">
              <Music2 className="pm-card__icon-img" aria-hidden="true" />
            </div>
          ...
          <article className="pm-card pm-card--ai">
            <div className="pm-card__icon">
              <Cpu className="pm-card__icon-img" aria-hidden="true" />
            </div>
