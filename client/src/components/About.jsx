  ...
  return (
    <div className="about-container">
      <div className='about-left'>
        <h2 className='home-header'>WHO IS DAN OBER?</h2>
      ...
      <p>When I'm not coding, I usually listening to, playing, writing, or recording music. I'm a drummer at heart, but also play guitar, bass, piano, turntables, harmonica, and vocals. I'm a competitive Rubik's cube solver and try to get in a couple cube solves a day to keep things fresh - my quickest solve is 0:57 seconds using F2L algorithms. I enjoy the outdoors - grilling, kayaking, hiking, and camping. Last fun fact: I'm a KCBS Certified BBQ Judge... I love food.</p>
